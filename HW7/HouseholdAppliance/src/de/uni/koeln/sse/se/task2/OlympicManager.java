...
public class OlympicManager {
    ...
    public OlympicManager() {
        ...
        Leaf womenTakewondo = new Leaf("Womens Takewondo",10,4);
        chinaWomenTeam.add(womenTakewondo);
        Leaf womenWaterpolo = new Leaf("Womens Waterpolo",4,1);
        chinaWomenTeam.add(womenWaterpolo);
        Leaf womenGym = new Leaf("Womens ArtisticGymnastics",6,0);
        chinaWomenTeam.add(womenGym);

        Composite chinaMenTeam = new Composite("China-Men-Team");
        chinaTeam.add(chinaMenTeam);
        Leaf menShooting = new Leaf("Men Shooting", 3, 0);
        ...
        Leaf cyclingWomen = new Leaf("Womens Cycling Team",12,7);
        womenGermany.add(cyclingWomen);
        Leaf tennisWomen = new Leaf("Womens Tennis",6,2);
